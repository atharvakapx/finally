...
<required_reading>
@/home/agent/finally/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/agent/finally/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/agent/finally/.claude
                  → checks /home/agent/finally/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/agent/finally/.claude/get-shit-done
                  → writes to /home/agent/finally/.claude/get-shit-done/hooks/
...
@/home/agent/finally/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/agent/finally/.claude/get-shit-done/references/common-bug-patterns.md
