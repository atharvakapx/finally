...
Reference full template: `/home/agent/finally/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/agent/finally/.claude/get-shit-done/templates/state.md`.
