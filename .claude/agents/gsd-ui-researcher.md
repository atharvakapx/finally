...
Use template from `/home/agent/finally/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/agent/finally/.claude/get-shit-done/templates/UI-SPEC.md`
