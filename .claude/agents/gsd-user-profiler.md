...
<reference>
@/home/agent/finally/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/agent/finally/.claude/get-shit-done/references/user-profiling.md` to load:
