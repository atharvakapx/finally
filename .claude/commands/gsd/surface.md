...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/agent/finally/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/agent/finally/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/agent/finally/.claude/commands/gsd
AGENTS_DIR=/home/agent/finally/.claude/agents
```
...
<execution_context>
Surface state file: `/home/agent/finally/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/agent/finally/.claude/skills/.gsd-profile`
Engine module: `/home/agent/finally/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/agent/finally/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
