...
```bash
INIT=$(node "/home/agent/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/agent/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
