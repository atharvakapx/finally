...
```
Agent(
  prompt="Read /home/agent/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/agent/finally/.claude/get-shit-done/templates/SECURITY.md`
