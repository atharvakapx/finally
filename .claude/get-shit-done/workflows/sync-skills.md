...
INSTALL_JS_GLOBAL="/home/agent/finally/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/agent/finally/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
