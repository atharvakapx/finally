...
```markdown
Read /home/agent/finally/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/agent/finally/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/agent/finally/.claude/agents/gsd-ui-checker.md for instructions.
